...
export const sendMessage = async (req, res) => {
    try {
        ...
        if (receiverSocketId) {
            io.to(receiverSocketId).emit("newMessage", newMessage) // can be called anything instead of newmessage but it should make sense
        }
...
export const getChatPartners = async (req, res) => {
    try {
        ...
        //find all messages where the loggin-in user is either sender or receiver
        const messages = await Message.find({
